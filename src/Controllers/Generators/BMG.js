...
for (var i = 0, n = allInputs.length; i < n; ++i) {
  ...
  if (input.id && (input.tagName == "INPUT" || input.tagName == "SELECT")) {
    ...
    if (input.id.includes('cep:txt-value')) {
      document.getElementById(input.id).onchange()
      setTimeout(()=>{
    ...
    if (input.id.includes('tipo_de_saque')) {
      document.getElementById(input.id).onchange()
      setTimeout(()=>{
        var allInputs = document.getElementsByTagName("*");
        for (var i = 0, n = allInputs.length; i < n; ++i) {
    ...
    if (input.id.includes('forma_de_credito')) {
      if ('${client.CodBancoCliente}' == 318 && document.getElementById(input.id).options) {
        if (document.getElementById(input.id).options[1] && document.getElementById(input.id).options[1].text == 'Conta BMG') document.getElementById(input.id).value = 1
        if (document.getElementById(input.id).options[2] && document.getElementById(input.id).options[2].text == 'Conta BMG') document.getElementById(input.id).value = 2
        if (document.getElementById(input.id).options[3] && document.getElementById(input.id).options[3].text == 'Conta BMG') document.getElementById(input.id).value = 3
        document.getElementById(input.id).onchange()
      } else if (document.getElementById(input.id).options) {
        if (document.getElementById(input.id).options[1] && document.getElementById(input.id).options[1].text == 'TRANSFERÊNCIA BANCÁRIA') document.getElementById(input.id).value = 1
        if (document.getElementById(input.id).options[2] && document.getElementById(input.id).options[2].text == 'TRANSFERÊNCIA BANCÁRIA') document.getElementById(input.id).value = 2
        if (document.getElementById(input.id).options[3] && document.getElementById(input.id).options[3].text == 'TRANSFERÊNCIA BANCÁRIA') document.getElementById(input.id).value = 3
        document.getElementById(input.id).onchange()
        setTimeout(()=>{
          var allInputs = document.getElementsByTagName("*");
          for (var i = 0, n = allInputs.length; i < n; ++i) {
            ...
            if (input.id && (input.tagName == "INPUT" || input.tagName == "SELECT")) {
              ...
              if (input.id.includes('findAgencia')) {
    ...
    if (input.id.includes('j_idt') && input.id.includes('selecionaUf')) {
      document.getElementById(input.id).onchange()
      setTimeout(()=>{
        var allInputs = document.getElementsByTagName("*");
        for (var i = 0, n = allInputs.length; i < n; ++i) {
    ...
    if (input.id.includes('data_emissao_identidade')) {
      document.getElementById(input.id).value = '01/01/2001'
      setTimeout(()=>{
        var allInputs = document.getElementsByTagName("*");
        for (var i = 0, n = allInputs.length; i < n; ++i) {
          var input = allInputs[i];
