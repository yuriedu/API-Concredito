...
const BMGCART = async (cliente) => {
  try {
    ...
    if (client && client.status) {
      ...
      var page1 = `if (document.getElementById('identificacao-form:j_idt27:find:txt-value')) { document.getElementById('identificacao-form:j_idt27:find:txt-value').value = '4277' } else { document.getElementById('identificacao-form:j_idt31:find:txt-value').value = '4277' }\n`
      page1 += `if (document.getElementById('identificacao-form:j_idt27:find:txt-value')) { document.getElementById('identificacao-form:j_idt27:find:txt-value').onchange() } else { document.getElementById('identificacao-form:j_idt31:find:txt-value').onchange() }`
      page1 += `setTimeout(()=>{\n`
