...
const BMGCART = async (cliente) => {
  try {
   ...
   if (client && client.status) {
      ...
      var page1 = `document.getElementById('identificacao-form:j_idt27:find:txt-value').value = '4277'\n`
      ...
      page2 += `document.getElementById('j_idt226:find:txt-value').value = '${client.EspecieAF}'\n`
      page2 += `document.getElementById('j_idt226:find:txt-value').onchange()\n`
