    ...
    if (getProposta.data.loan_track && getProposta.data.loan_track.current_activity_description) {
      var fases = [
        { situacao: 'INT', atividade: 'PAGO', status: [
          { status: '409', fase: '3920', faseName: 'PROPOSTA PAGA', motivo: '', oldFase: ['2','4002','9','9232', '9923', '692'] }, //CONCLUIDO
        ]},
        { situacao: 'PEN', atividade: 'AGUARDA FORM DIG WEB', status: [
          { status: '476', fase: '10293', faseName: 'Verificação manual OP', motivo: 'Verificar se o cliente já assinou ou está aguardando envio do documento', oldFase: ['2','4002'] }, //NÃO INICIADO //AGUARDANDO ENVIO DOC
